...
export const DOCUMENTED_WORKFLOW_REGISTRY = Object.freeze([
  { path: "README.md", line: 38, command: "npm install @ahasend/sdk", owner: "installed-package" },
  {
    path: "README.md",
    line: 536,
  ...
  { path: "README.md", line: 537, command: "cd ahasend-ts", owner: "source-setup" },
  { path: "README.md", line: 538, command: "npm ci", owner: "source-setup" },
  {
    path: "README.md",
    line: 540,
